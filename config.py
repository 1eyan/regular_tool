...
parser.add_argument('--h5File', type=str, default='/home/chengzhitong/5d_regular/seis_flow_data12V2/generate_py/h5/segc3/segc3_1.h5')
parser.add_argument('--h5File_regular', type=str, default='/home/chengzhitong/5d_regular/seis_flow_data12V2/generate_py/h5/segc3/segc3_1.h5')
...
parser.add_argument('--time_ps', type=int, default=632)
parser.add_argument('--trace_ps', type=int, default=128)
parser.add_argument('--sample_num', type=int, default=1248)
